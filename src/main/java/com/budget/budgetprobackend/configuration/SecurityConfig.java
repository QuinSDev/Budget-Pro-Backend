...
import com.budget.budgetprobackend.security.JwtAuthenticationFilter;
 ...
 * Esta clase define la configuración de seguridad de la aplicación, incluyendo
 * la autorización de rutas, la configuración de filtros de autenticación
...
public class SecurityConfig {
     ...
     * Este método establece la cadena de filtros de seguridad que controlan
     * la autentitación y la autorización de las solicitudes entrantes.
     * Configura la desactivación de CSRF, la autorización de rutas, la gestión
     * de sesiones sin estado y la adición de filtros personalizados.
     * 
        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                    authRequest
                        ...
                        con "/auth" sean accesibles sin autenticación. */
